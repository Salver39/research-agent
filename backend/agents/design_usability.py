...
from prompts.design_usability import SYSTEM


class DesignUsabilityAgent(BaseAgent):
    ...
    def build_messages(self, state: dict[str, Any], user_input: str) -> list[dict]:
        ...
        if out_of_scope:
            excluded_block = (
                "\nИСКЛЮЧЁННЫЕ гипотезы (юзабилити-тест не подходит для их проверки — НЕ создавай для них заданий, НЕ упоминай их):\n"
